...
export function Office(props) {
  ...
  const textureVDO = useVideoTexture("textures/vscode.mp4");
  ...
  const textureGlassMaterialOpacity = useMotionValue(0);

  useEffect(() => {
    animate(textureOpacity, section === 0 ? 1 : 0);
    animate(textureGlassMaterialOpacity, section === 0 ? 0.42 : 0);
  }, [section]);

  useFrame(() => {
    textureMaterial.opacity = textureOpacity.get();
    textureGlassMaterial.opacity = textureGlassMaterialOpacity.get();
  });
  ...
  return (
    <group {...props} dispose={null}>
      ...
      >
        <mesh name="iMac_1" geometry={nodes.iMac_1.geometry}>
          position={[0, 0, 0]}
          scale={[0.1, 0.1, 0.1]}
          rotation={[Math.PI, -1.1, Math.PI]}
